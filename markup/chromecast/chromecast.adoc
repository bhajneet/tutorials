...
Open Google Chrome and enter the display URL of Shabad OS into the address bar. If the same device is running Shabad OS and will be used to cast, then simply use http://localhost:1699 (see link:../url-endpoints/url-endpoints.adoc[URL Endpoints] for more flexible arrangements across other devices).
...
image::../chromecast/google-chrome-cast-button.png[Cast Button in Google Chrome,300]
...
image::../chromecast/google-chrome-resizing-info.png[Resizing the Google Chrome tab,300]
...
image::../chromecast/google-chrome-undock-devtools.png[How to undock the devtools into a separate window,300]
